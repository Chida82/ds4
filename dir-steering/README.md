...
--dir-steering-ffn-decay-tokens N
                          move FFN steering scale with a smoothstep cubic curve to the final value after N generated tokens
...
the response at scale `-2`, follows a smoothstep cubic curve toward `-0.1`,
reaches `-0.1` after 20 generated tokens, and stays at `-0.1` afterward.
