...
--dir-steering-ffn-decay-tokens N
                          quadratically move FFN steering scale to the final value after N generated tokens
...
the response at scale `-2`, moves quadratically toward `-0.1`, reaches `-0.1`
after 20 generated tokens, and stays at `-0.1` afterward.
